        ...
        <div>
            ...
            <p className="text-lg text-white/80 mb-6">
             ...
             <p className="text-lg text-white/80">
              Continuously exploring emerging technologies and best practices to build context-aware applications that automate workflows and enhance user experiences—demonstrating commitment to leveraging cutting-edge solutions to solve real-world challenges. Always iterating, always learning: I focus on showcasing only my strongest, most relevant work to highlight tangible value for clients and collaborators.
            </p>
        </div>
      </div>
    </motion.div>
